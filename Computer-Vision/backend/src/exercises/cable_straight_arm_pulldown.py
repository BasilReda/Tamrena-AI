    ...
    counter_rules: list[AngleCounterRule] = field(
        default_factory=lambda: [
            AngleCounterRule(
                ...
                up_angle=70,                  # arms overhead — UP stage (angle >= 160)
                ...
                min_rom_angle=35,              # must reach <= 60° for a GOOD rep (deep enough)
                max_rom_angle=120,             # must reach >= 160° for a GOOD rep (full extension)
