...
from .hyperextension import HyperextensionExercise
...
from .upright_row import UprightRowExercise
...
registry.register("hyp", HyperextensionExercise())
registry.register("upright_row", UprightRowExercise())
registry.register("up", UprightRowExercise())   # alias for your CLI shortcut