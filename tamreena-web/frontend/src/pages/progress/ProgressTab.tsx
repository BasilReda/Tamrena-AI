...
const MOCK_BASIL_NARRATIVE =
  'Comprehensive 30-Day Synthesis Report for athlete basilreda123: You completed 1,420 total reps with 90.1% perfect form execution. Computer Vision tracked 140 flawed reps across 4 key movements. Combined with your InBody scan results (+1.8kg muscle mass, -2.1% body fat), Tamrena-AI has passed these exercise error corrections alongside your biometrics into the Workout Engine to generate your Phase 2 Optimized Training Protocol.';
