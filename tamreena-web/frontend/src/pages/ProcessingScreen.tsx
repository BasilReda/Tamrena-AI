  ...
  return (
    ...
    >
      <div className="glass-panel" style={{ padding: '48px', maxWidth: '540px', width: '100%', textAlign: 'center', background: 'rgba(15, 23, 42, 0.85)', boxShadow: 'var(--shadow-emerald)' }}>
        ...
        <p id="processing-status" style={{ color: '#38bdf8', fontSize: '15px', lineHeight: 1.6, margin: '0 0 16px 0', fontWeight: 500 }}>
          {statusText}
        </p>

        <p style={{ color: '#64748b', fontSize: '13px', margin: 0 }}>
          Deep multi-agent reasoning across training principles & exercise databases is running. This may take 1–3 minutes on ITI Bedrock.
        </p>

        {/* Shimmer Bar */}
        <div style={{ marginTop: '24px', height: '6px', borderRadius: '3px', overflow: 'hidden' }} className="shimmer" />
      </div>
    </div>
  );
}
